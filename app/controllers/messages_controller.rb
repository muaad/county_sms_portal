...
class MessagesController < ApplicationController
  ...
  # POST /messages.json
  def create
    # {"MSISDN"=>"254722778438", "Shortcode"=>"20619", "Reference"=>"13.1501.1436499291.1", "Content"=>"County hello tests", "Channel"=>"KENYA.SAFARICOM", "DataType"=>"0", "DateReceived"=>"1436499291", "CampaignID"=>"120750", "Trigger"=>"COUNTY", "controller"=>"messages", "action"=>"create"}
    ...
    begin
      ...
      if text.downcase.start_with?("county")
        ...
        HTTParty.post("#{DOCWHO_URL}/questions", body: {text: msg, phone_number: phone_number, source: "SMS"})
